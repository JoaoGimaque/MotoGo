package com.apptcc.motogo.helper;
...
import com.apptcc.motogo.activity.MapsActivity;
import com.apptcc.motogo.activity.PassageiroActivity;
import com.apptcc.motogo.activity.RequisicoesActivity;
...
public class UsuarioFirebase {
    ...
    public static void atualizarDadosLocalizacao(double lat, double lon){
        ...
        //denifine no local de usuario
        DatabaseReference localUsuario = ConfiguracaoFirebase.getFirebaseDatabase()
                .child("local_usuario");
        GeoFire geoFire = new GeoFire(localUsuario);

        //recupera dados do usuairo
